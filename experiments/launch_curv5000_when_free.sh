...
python -u experiments/prototypes/solver_curvature.py --dataset eurosat --path data/eurosat/EuroSAT_RGB --img-size 224 224 --subset-size 5000 --out-dir models/solver_curvature_n5000 > logs/curv5000_eurosat.log 2>&1 || { echo "FAILED eurosat rc=$?"; exit 1; }
python -u experiments/prototypes/solver_curvature.py --dataset resisc45 --path data/resisc45/NWPU-RESISC45 --img-size 256 256 --subset-size 5000 --out-dir models/solver_curvature_n5000 > logs/curv5000_resisc45.log 2>&1 || { echo "FAILED resisc45 rc=$?"; exit 1; }
