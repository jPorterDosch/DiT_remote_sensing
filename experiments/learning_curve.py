...
FINDINGS (2026-08-22, RESEARCH_NOTES 6e). EuroSAT near-converged at n=5000 (+0.0054 last
step); RESISC45 still climbing (+0.0214 per 1500 images) -- all RESISC45 LEVELS at n=5000
remain underestimates; level claims must say "at n=5000".
"""
...
ARMS = {
    "eurosat DiT ens1 (C=0.01)": (
        "models/n5000_eurosat_oneshot_ens1/eurosat_flux_0b91191d+42/multistep_train_feats_oneshot_g1.0.npz",
        0.01,
    ),
    "resisc45 DiT ens1 (C=0.1)": (
...
def main():
    for name, (path, c) in ARMS.items():
        ...
        for n in NS:
            ...
            a = float(np.mean(Parallel(n_jobs=5)(delayed(_fold)(xs, ys, tr, va, c) for tr, va in jobs)))
