# --------------------------------------------------------
# We adapt SAT-MAE++ to our setting to compare with our proposed DiT-MAE model.
...
def mae_vit_large_patch16_dec512d8b(**kwargs: dict[str, Any]) -> MaskedAutoencoderViT:
